...
import com.india.shoping.Users.LoginActivity;
import com.india.shoping.Users.SettingsActivity;
...
private Button verifybtn;
    ...
    private void setanswers(){
        ...
        if(ans1.isEmpty()){
            ...
            DatabaseReference reference= FirebaseDatabase.getInstance()
                    .getReference().child("Users").child("9149312323");
    ...
    private void displaypreviousanswers(){
        Paper.init(this);
        String phonekey=Paper.book().read("loveyou");
        DatabaseReference reference= FirebaseDatabase.getInstance()
