...
public class Donate extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        productimage = findViewById(R.id.Select_Donate_Image);
        productname = findViewById(R.id.Donate_product_name);
        productdescription = findViewById(R.id.donate_product_description);
//        productprice = findViewById(R.id.donate_product_price);
        addproduct = findViewById(R.id.donate_product);
        loadingbar = new ProgressDialog(this);
        ImageRef = FirebaseStorage.getInstance().getReference().child("Donate Products");
        Productsref = FirebaseDatabase.getInstance().getReference().child("Donate Products");
    ...
    private void Storeimageinformation() {
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                loadingbar.dismiss();
                Toast.makeText(Donate.this, "Error" + message, Toast.LENGTH_SHORT).show();
            }
            ...
            public Task<Uri> then(@NonNull Task<UploadTask.TaskSnapshot> task) throws Exception {
                ...
                .addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        Toast.makeText(Donate.this, "get Successfully"+downloadimageurl, Toast.LENGTH_SHORT).show();
                    }
                });
    }
    ...
    private void Saveproductinfotodatabase() {
        ...
        Productsref.child(ProductRandomkey).updateChildren(ProductMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
//                    loadingbar.dismiss();
                    Intent intent = new Intent(Donate.this, AdminCategoryActivity.class);
